...
## 12. Remaining User Fill-Ins

Before submission, fill in only the items that cannot be inferred from the current project files:

- Final screenshots in the `screenshots` folder.
- Sprint 0 / Sprint 1 backlog and actual sprint work.
- Formal contribution percentages or grades for each group member, if required.
- Any final prototype changes made after this report version.
